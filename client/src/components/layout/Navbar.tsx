...
const Navbar: React.FC = () => {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        if (searchTerm.trim()) {
            ...
            // Opcionalmente, puedes limpiar el término de búsqueda después de buscar
            // Comentado porque puede ser mejor mantenerlo para mostrar lo que se buscó
            // setSearchTerm('');
        }
    };
                            ...
                            <div className="ml-4 relative flex-shrink-0">
                                ...
                                {mobileMenuOpen && (
                                    ...
                                    >
                                        ...
                                        {(user?.rol === "instructor" || user?.rol === "admin") && (
                                            <Link
